/*
* A Promised NodeJS Module for connecting with the Qredit ASLP API
*/

const request = require("request");
const Big = require('big.js');
const arkApi = require("./../lib/arkApi");
const arkjs = require("arkjs");
const aapi = new arkApi.default();

var aslpApi = /** @class */ (function () {

    function aslpApi(apiURL) {
        if (apiURL === void 0)
            this.apiURL = 'https://arkaslp2.qredit.cloud/api';
        else
            this.apiURL = apiURL;
    ...
    aslpApi.prototype.getApiUrl = function () {
    ...
    aslpApi.prototype.getStatus = function () {
    ...
    aslpApi.prototype.getPeerInfo = function () {
    ...
    aslpApi.prototype.listTokens = function (limit = 100, page = 1) {
    ...
    aslpApi.prototype.getToken = function (tokenid) {
    ...
    aslpApi.prototype.getTokenWithMeta = function (tokenid) {
    ...
    aslpApi.prototype.getTokenIdByTxid = function (transactionid) {
    ...
    aslpApi.prototype.getTokensByOwner = function (address = '', limit = 100, page = 1) {
    ...
    aslpApi.prototype.listAddresses = function (limit = 100, page = 1) {
    ...
    aslpApi.prototype.getAddress = function (address) {
    ...
    aslpApi.prototype.getAddressesByTokenId = function (tokenid = '', limit = 100, page = 1) {
    ...
    aslpApi.prototype.getBalance = function (tokenid = '', address = '') {
    ...
    aslpApi.prototype.listTransactions = function (limit = 100, page = 1) {
    ...
    aslpApi.prototype.getTransaction = function (transactionid = '') {
    ...
    aslpApi.prototype.listTokenTransactions = function (tokenid = '', limit = 100, page = 1) {
    ...
    aslpApi.prototype.listTokenAddressTransactions = function (tokenid = '', address = '', limit = 100, page = 1) {
    ...
    aslpApi.prototype.generateToken = function (passPhrase = '', secondPassphrase = null, tokenName = '', tokenTicker = '', tokenQuantity = 0, tokenDecimals = 8, tokenUri = '', tokenNote = '', tokenPausable = false, tokenMintable = false) {
            ...
            (async () => {
                ...
                try {
                    ...
                    if (error == false) {
                        ...
                        var jsontemplate = { "aslp1": { "tp": "GENESIS", "na": name, "sy": ticker, "de": decimals.toString(), "qt": rawquantity, "du": uri, "no": note, "pa": pausable, "mi": mintable } };
                        var body = JSON.stringify(jsontemplate);

                        var toAddress = 'AXQRDotxfrL3cV87NcoLeAgswBECoVs9Sv'; // ASLP-1 Master Address
                        var feeOverride = 2000000;  // 0.02 ARK
                        var arkAmount = 1; // 0.00000001 ARK
                        var vendorField = body;
                        var version = null; // Not typically used

                        var transaction = arkjs.transaction.createTransaction(toAddress, arkAmount, vendorField, passPhrase, secondPassphrase, version, feeOverride);

                        var transactionId = transaction.id;

                        var sendResult = await aapi.createTransaction([transaction]);
    ...
    aslpApi.prototype.mintToken = function (passPhrase = '', secondPassphrase = null, tokenId = '', mintQuantity = 0, transactionNote = '') {
            ...
            (async () => {
                ...
                try {
                    ...
                    if (error == false) {
                        ...
                        var jsontemplate = { "aslp1": { "tp": "MINT", "id": tokenId, "qt": rawquantity, "no": transactionNote } };
    ...
    aslpApi.prototype.burnToken = function (passPhrase = '', secondPassphrase = null, tokenId = '', burnQuantity = 0, transactionNote = '') {
            ...
            (async () => {
                ...
                try {
                    ...
                    if (error == false) {
                        ...
                        var jsontemplate = { "aslp1": { "tp": "BURN", "id": tokenId, "qt": rawquantity, "no": transactionNote } };
    ...
    aslpApi.prototype.sendToken = function (passPhrase = '', secondPassphrase = null, tokenId = '', toAddress = '', sendQuantity = 0, transactionNote = '') {
            ...
            (async () => {
                ...
                try {
                    ...
                    if (tokeninfo[0] && tokeninfo[0].tokenDetails) {
                        ...
                        var senderkeys = arkjs.crypto.getKeys(passPhrase);
                        var senderpublickey = senderkeys.publicKey;
                        var senderaddress = arkjs.crypto.getAddress(senderpublickey);
                    ...
                    if (error == false) {
                        ...
                        var jsontemplate = { "aslp1": { "tp": "SEND", "id": tokenId, "qt": rawquantity, "no": transactionNote } };
    ...
    aslpApi.prototype.pauseToken = function (passPhrase = '', secondPassphrase = null, tokenId = '', transactionNote = '') {
            ...
            (async () => {
                ...
                try {
                    ...
                    if (error == false) {
                        ...
                        var jsontemplate = { "aslp1": { "tp": "PAUSE", "id": tokenId, "no": transactionNote } };
    ...
    aslpApi.prototype.resumeToken = function (passPhrase = '', secondPassphrase = null, tokenId = '', transactionNote = '') {
            ...
            (async () => {
                ...
                try {
                    ...
                    if (error == false) {
                        ...
                        var jsontemplate = { "aslp1": { "tp": "RESUME", "id": tokenId, "no": transactionNote } };
    ...
    aslpApi.prototype.newTokenOwner = function (passPhrase = '', secondPassphrase = null, tokenId = '', newOwnerAddress = '', transactionNote = '') {
        ...
        return new Promise((resolve, reject) => {
            ...
            (async () => {
                ...
                try {
                    ...
                    if (error == false) {
                        var jsontemplate = { "aslp1": { "tp": "NEWOWNER", "id": tokenId, "no": transactionNote } };
