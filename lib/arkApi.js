...
var arkApi = /** @class */ (function () {

    function arkApi(apiURL) {
        if (apiURL === void 0)
            this.apiURL = 'https://explorer.ark.io/api/v2';
        else
            this.apiURL = apiURL;
    ...
    arkApi.prototype.getApiUrl = function () {
    ...
    arkApi.prototype.getBlockChain = function () {
    ...
    arkApi.prototype.getBlockHeight = function () {
    ...
    arkApi.prototype.listBlocks = function (page, limit, id, height, orderBy) {
    ...
    arkApi.prototype.getBlockByHeight = function (height) {
    ...
    arkApi.prototype.getBlockByID = function (id) {
    ...
    arkApi.prototype.getLastBlock = function () {
    ...
    arkApi.prototype.getTransactionsByBlockID = function (id) {
    ...
    arkApi.prototype.searchBlocks = function (page, limit, body) {
    ...
    arkApi.prototype.listDelegates = function (page, limit, orderBy) {
    ...
    arkApi.prototype.getDelegate = function (identifier) {
    ...
    arkApi.prototype.getDelegateBlocks = function (identifier, page, limit) {
    ...
    arkApi.prototype.getDelegateVoters = function (identifier, page, limit) {
    ...
    arkApi.prototype.searchDelegates = function (page, limit, body) {
    ...
    arkApi.prototype.getNodeConfig = function () {
    ...
    arkApi.prototype.getNodeCryptoConfig = function () {
    ...
    arkApi.prototype.getNodeFeeStats = function () {
    ...
    arkApi.prototype.getNodeStatus = function () {
    ...
    arkApi.prototype.getNodeSyncStatus = function () {
    ...
    arkApi.prototype.getPeers = function (page, limit, port, status, os, version, orderBy) {
    ...
    arkApi.prototype.getPeerByIP = function (ip) {
    ...
    arkApi.prototype.createTransaction = function (transactions) {
    ...
    arkApi.prototype.getTransactionByID = function (id) {
    ...
    arkApi.prototype.listTransactions = function (page, limit, type, blockId, id, orderBy) {
    ...
    arkApi.prototype.listUnconfirmedTransactions = function (page, limit) {
    ...
    arkApi.prototype.getUnconfirmedTransactionByID = function (id) {
    ...
    arkApi.prototype.searchTransactions = function (page, limit, body) {
    ...
    arkApi.prototype.getTransactionTypes = function () {
    ...
    arkApi.prototype.getTransactionFees = function () {
    ...
    arkApi.prototype.listVotes = function (page, limit, orderBy) {
    ...
    arkApi.prototype.getVoteByID = function (id) {
    ...
    arkApi.prototype.listWallets = function (page, limit, orderBy) {
    ...
    arkApi.prototype.getWalletByID = function (id) {
    ...
    arkApi.prototype.getWalletBalance = function (id) {
    ...
    arkApi.prototype.getWalletTransactions = function (id, page, limit) {
    ...
    arkApi.prototype.getWalletReceivedTransactions = function (id, page, limit) {
    ...
    arkApi.prototype.getWalletSentTransactions = function (id, page, limit) {
    ...
    arkApi.prototype.getWalletVotes = function (id, page, limit) {
    ...
    arkApi.prototype.getTopWallets = function (page, limit) {
    ...
    arkApi.prototype.searchWallets = function (page, limit, body) {
