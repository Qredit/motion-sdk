...
var blockpoolApi = /** @class */ (function () {

    function blockpoolApi(apiURL) {
        if (apiURL === void 0)
            this.apiURL = 'http://116.202.27.200:9035/api/v2';
        else
            this.apiURL = apiURL;
    ...
    blockpoolApi.prototype.getApiUrl = function () {
    ...
    blockpoolApi.prototype.getBlockChain = function () {
    ...
    blockpoolApi.prototype.getBlockHeight = function () {
    ...
    blockpoolApi.prototype.listBlocks = function (page, limit, id, height, orderBy) {
    ...
    blockpoolApi.prototype.getBlockByHeight = function (height) {
    ...
    blockpoolApi.prototype.getBlockByID = function (id) {
    ...
    blockpoolApi.prototype.getLastBlock = function () {
    ...
    blockpoolApi.prototype.getTransactionsByBlockID = function (id) {
    ...
    blockpoolApi.prototype.searchBlocks = function (page, limit, body) {
    ...
    blockpoolApi.prototype.listDelegates = function (page, limit, orderBy) {
    ...
    blockpoolApi.prototype.getDelegate = function (identifier) {
    ...
    blockpoolApi.prototype.getDelegateBlocks = function (identifier, page, limit) {
    ...
    blockpoolApi.prototype.getDelegateVoters = function (identifier, page, limit) {
    ...
    blockpoolApi.prototype.searchDelegates = function (page, limit, body) {
    ...
    blockpoolApi.prototype.getNodeConfig = function () {
    ...
    blockpoolApi.prototype.getNodeCryptoConfig = function () {
    ...
    blockpoolApi.prototype.getNodeFeeStats = function () {
    ...
    blockpoolApi.prototype.getNodeStatus = function () {
    ...
    blockpoolApi.prototype.getNodeSyncStatus = function () {
    ...
    blockpoolApi.prototype.getPeers = function (page, limit, port, status, os, version, orderBy) {
    ...
    blockpoolApi.prototype.getPeerByIP = function (ip) {
    ...
    blockpoolApi.prototype.createTransaction = function (transactions) {
    ...
    blockpoolApi.prototype.getTransactionByID = function (id) {
    ...
    blockpoolApi.prototype.listTransactions = function (page, limit, type, blockId, id, orderBy) {
    ...
    blockpoolApi.prototype.listUnconfirmedTransactions = function (page, limit) {
    ...
    blockpoolApi.prototype.getUnconfirmedTransactionByID = function (id) {
    ...
    blockpoolApi.prototype.searchTransactions = function (page, limit, body) {
    ...
    blockpoolApi.prototype.getTransactionTypes = function () {
    ...
    blockpoolApi.prototype.getTransactionFees = function () {
    ...
    blockpoolApi.prototype.listVotes = function (page, limit, orderBy) {
    ...
    blockpoolApi.prototype.getVoteByID = function (id) {
    ...
    blockpoolApi.prototype.listWallets = function (page, limit, orderBy) {
    ...
    blockpoolApi.prototype.getWalletByID = function (id) {
    ...
    blockpoolApi.prototype.getWalletBalance = function (id) {
    ...
    blockpoolApi.prototype.getWalletTransactions = function (id, page, limit) {
    ...
    blockpoolApi.prototype.getWalletReceivedTransactions = function (id, page, limit) {
    ...
    blockpoolApi.prototype.getWalletSentTransactions = function (id, page, limit) {
    ...
    blockpoolApi.prototype.getWalletVotes = function (id, page, limit) {
    ...
    blockpoolApi.prototype.getTopWallets = function (page, limit) {
    ...
    blockpoolApi.prototype.searchWallets = function (page, limit, body) {
