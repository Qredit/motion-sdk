...
var radiansApi = /** @class */ (function () {

    function radiansApi(apiURL) {
        if (apiURL === void 0)
            /* needs ssl in the future doto */
            this.apiURL = 'https://api.radians.nl/api/v2';
        else
            this.apiURL = apiURL;
    ...
    radiansApi.prototype.getApiUrl = function () {
    ...
    radiansApi.prototype.getBlockChain = function () {
    ...
    radiansApi.prototype.getBlockHeight = function () {
    ...
    radiansApi.prototype.listBlocks = function (page, limit, id, height, orderBy) {
    ...
    radiansApi.prototype.getBlockByHeight = function (height) {
    ...
    radiansApi.prototype.getBlockByID = function (id) {
    ...
    radiansApi.prototype.getLastBlock = function () {
    ...
    radiansApi.prototype.getTransactionsByBlockID = function (id) {
    ...
    radiansApi.prototype.searchBlocks = function (page, limit, body) {
    ...
    radiansApi.prototype.listDelegates = function (page, limit, orderBy) {
    ...
    radiansApi.prototype.getDelegate = function (identifier) {
    ...
    radiansApi.prototype.getDelegateBlocks = function (identifier, page, limit) {
    ...
    radiansApi.prototype.getDelegateVoters = function (identifier, page, limit) {
    ...
    radiansApi.prototype.searchDelegates = function (page, limit, body) {
    ...
    radiansApi.prototype.getNodeConfig = function () {
    ...
    radiansApi.prototype.getNodeCryptoConfig = function () {
    ...
    radiansApi.prototype.getNodeFeeStats = function () {
    ...
    radiansApi.prototype.getNodeStatus = function () {
    ...
    radiansApi.prototype.getNodeSyncStatus = function () {
    ...
    radiansApi.prototype.getPeers = function (page, limit, port, status, os, version, orderBy) {
    ...
    radiansApi.prototype.getPeerByIP = function (ip) {
    ...
    radiansApi.prototype.createTransaction = function (transactions) {
    ...
    radiansApi.prototype.getTransactionByID = function (id) {
    ...
    radiansApi.prototype.listTransactions = function (page, limit, type, blockId, id, orderBy) {
    ...
    radiansApi.prototype.listUnconfirmedTransactions = function (page, limit) {
    ...
    radiansApi.prototype.getUnconfirmedTransactionByID = function (id) {
    ...
    radiansApi.prototype.searchTransactions = function (page, limit, body) {
    ...
    radiansApi.prototype.getTransactionTypes = function () {
    ...
    radiansApi.prototype.getTransactionFees = function () {
    ...
    radiansApi.prototype.listVotes = function (page, limit, orderBy) {
    ...
    radiansApi.prototype.getVoteByID = function (id) {
    ...
    radiansApi.prototype.listWallets = function (page, limit, orderBy) {
    ...
    radiansApi.prototype.getWalletByID = function (id) {
    ...
    radiansApi.prototype.getWalletBalance = function (id) {
    ...
    radiansApi.prototype.getWalletTransactions = function (id, page, limit) {
    ...
    radiansApi.prototype.getWalletReceivedTransactions = function (id, page, limit) {
    ...
    radiansApi.prototype.getWalletSentTransactions = function (id, page, limit) {
    ...
    radiansApi.prototype.getWalletVotes = function (id, page, limit) {
    ...
    radiansApi.prototype.getTopWallets = function (page, limit) {
    ...
    radiansApi.prototype.searchWallets = function (page, limit, body) {
