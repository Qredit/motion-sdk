...
var testnetQreditApi = /** @class */ (function () {

    function testnetQreditApi(apiURL) {
        if (apiURL === void 0)
            this.apiURL = 'https://qredit.dev/api/v2';
        else
            this.apiURL = apiURL;
    ...
    testnetQreditApi.prototype.getApiUrl = function () {
    ...
    testnetQreditApi.prototype.getBlockChain = function () {
    ...
    testnetQreditApi.prototype.getBlockHeight = function () {
    ...
    testnetQreditApi.prototype.listBlocks = function (page, limit, id, height, orderBy) {
    ...
    testnetQreditApi.prototype.getBlockByHeight = function (height) {
    ...
    testnetQreditApi.prototype.getBlockByID = function (id) {
    ...
    testnetQreditApi.prototype.getLastBlock = function () {
    ...
    testnetQreditApi.prototype.getTransactionsByBlockID = function (id) {
    ...
    testnetQreditApi.prototype.searchBlocks = function (page, limit, body) {
    ...
    testnetQreditApi.prototype.listDelegates = function (page, limit, orderBy) {
    ...
    testnetQreditApi.prototype.getDelegate = function (identifier) {
    ...
    testnetQreditApi.prototype.getDelegateBlocks = function (identifier, page, limit) {
    ...
    testnetQreditApi.prototype.getDelegateVoters = function (identifier, page, limit) {
    ...
    testnetQreditApi.prototype.searchDelegates = function (page, limit, body) {
    ...
    testnetQreditApi.prototype.getNodeConfig = function () {
    ...
    testnetQreditApi.prototype.getNodeCryptoConfig = function () {
    ...
    testnetQreditApi.prototype.getNodeFeeStats = function () {
    ...
    testnetQreditApi.prototype.getNodeStatus = function () {
    ...
    testnetQreditApi.prototype.getNodeSyncStatus = function () {
    ...
    testnetQreditApi.prototype.getPeers = function (page, limit, port, status, os, version, orderBy) {
    ...
    testnetQreditApi.prototype.getPeerByIP = function (ip) {
    ...
    testnetQreditApi.prototype.createTransaction = function (transactions) {
    ...
    testnetQreditApi.prototype.getTransactionByID = function (id) {
    ...
    testnetQreditApi.prototype.listTransactions = function (page, limit, type, blockId, id, orderBy) {
    ...
    testnetQreditApi.prototype.listUnconfirmedTransactions = function (page, limit) {
    ...
    testnetQreditApi.prototype.getUnconfirmedTransactionByID = function (id) {
    ...
    testnetQreditApi.prototype.searchTransactions = function (page, limit, body) {
    ...
    testnetQreditApi.prototype.getTransactionTypes = function () {
    ...
    testnetQreditApi.prototype.getTransactionFees = function () {
    ...
    testnetQreditApi.prototype.listVotes = function (page, limit, orderBy) {
    ...
    testnetQreditApi.prototype.getVoteByID = function (id) {
    ...
    testnetQreditApi.prototype.listWallets = function (page, limit, orderBy) {
    ...
    testnetQreditApi.prototype.getWalletByID = function (id) {
    ...
    testnetQreditApi.prototype.getWalletBalance = function (id) {
    ...
    testnetQreditApi.prototype.getWalletTransactions = function (id, page, limit) {
    ...
    testnetQreditApi.prototype.getWalletReceivedTransactions = function (id, page, limit) {
    ...
    testnetQreditApi.prototype.getWalletSentTransactions = function (id, page, limit) {
    ...
    testnetQreditApi.prototype.getWalletVotes = function (id, page, limit) {
    ...
    testnetQreditApi.prototype.getTopWallets = function (page, limit) {
    ...
    testnetQreditApi.prototype.searchWallets = function (page, limit, body) {
    ...
    return testnetQreditApi;

}());

exports.default = testnetQreditApi;