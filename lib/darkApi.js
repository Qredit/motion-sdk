...
var darkApi = /** @class */ (function () {
    ...
    function darkApi(apiURL) {
        if (apiURL === void 0)
            /* need to change to devnet url */
            this.apiURL = 'https://explorer.ark.io/api';
        else
            this.apiURL = apiURL;
    ...
    darkApi.prototype.getApiUrl = function () {
    ...
    darkApi.prototype.getBlockChain = function () {
    ...
    darkApi.prototype.getBlockHeight = function () {
    ...
    darkApi.prototype.listBlocks = function (page, limit, id, height, orderBy) {
    ...
    darkApi.prototype.getBlockByHeight = function (height) {
    ...
    darkApi.prototype.getBlockByID = function (id) {
    ...
    darkApi.prototype.getLastBlock = function () {
    ...
    darkApi.prototype.getTransactionsByBlockID = function (id) {
    ...
    darkApi.prototype.searchBlocks = function (page, limit, body) {
    ...
    darkApi.prototype.listDelegates = function (page, limit, orderBy) {
    ...
    darkApi.prototype.getDelegate = function (identifier) {
    ...
    darkApi.prototype.getDelegateBlocks = function (identifier, page, limit) {
    ...
    darkApi.prototype.getDelegateVoters = function (identifier, page, limit) {
    ...
    darkApi.prototype.searchDelegates = function (page, limit, body) {
    ...
    darkApi.prototype.getNodeConfig = function () {
    ...
    darkApi.prototype.getNodeCryptoConfig = function () {
    ...
    darkApi.prototype.getNodeFeeStats = function () {
    ...
    darkApi.prototype.getNodeStatus = function () {
    ...
    darkApi.prototype.getNodeSyncStatus = function () {
    ...
    darkApi.prototype.getPeers = function (page, limit, port, status, os, version, orderBy) {
    ...
    darkApi.prototype.getPeerByIP = function (ip) {
    ...
    darkApi.prototype.createTransaction = function (transactions) {
    ...
    darkApi.prototype.getTransactionByID = function (id) {
    ...
    darkApi.prototype.listTransactions = function (page, limit, type, blockId, id, orderBy) {
    ...
    darkApi.prototype.listUnconfirmedTransactions = function (page, limit) {
    ...
    darkApi.prototype.getUnconfirmedTransactionByID = function (id) {
    ...
    darkApi.prototype.searchTransactions = function (page, limit, body) {
    ...
    darkApi.prototype.getTransactionTypes = function () {
    ...
    darkApi.prototype.getTransactionFees = function () {
    ...
    darkApi.prototype.listVotes = function (page, limit, orderBy) {
    ...
    darkApi.prototype.getVoteByID = function (id) {
    ...
    darkApi.prototype.listWallets = function (page, limit, orderBy) {
    ...
    darkApi.prototype.getWalletByID = function (id) {
    ...
    darkApi.prototype.getWalletBalance = function (id) {
    ...
    darkApi.prototype.getWalletTransactions = function (id, page, limit) {
    ...
    darkApi.prototype.getWalletReceivedTransactions = function (id, page, limit) {
    ...
    darkApi.prototype.getWalletSentTransactions = function (id, page, limit) {
    ...
    darkApi.prototype.getWalletVotes = function (id, page, limit) {
    ...
    darkApi.prototype.getTopWallets = function (page, limit) {
    ...
    darkApi.prototype.searchWallets = function (page, limit, body) {
