...
var dswipeApi = /** @class */ (function () {

    function dswipeApi(apiURL) {
        if (apiURL === void 0)
            this.apiURL = 'http://3.9.91.207:4003/api';
        else
            this.apiURL = apiURL;
    ...
    dswipeApi.prototype.getApiUrl = function () {
    ...
    dswipeApi.prototype.getBlockChain = function () {
    ...
    dswipeApi.prototype.getBlockHeight = function () {
    ...
    dswipeApi.prototype.listBlocks = function (page, limit, id, height, orderBy) {
    ...
    dswipeApi.prototype.getBlockByHeight = function (height) {
    ...
    dswipeApi.prototype.getBlockByID = function (id) {
    ...
    dswipeApi.prototype.getLastBlock = function () {
    ...
    dswipeApi.prototype.getTransactionsByBlockID = function (id) {
    ...
    dswipeApi.prototype.searchBlocks = function (page, limit, body) {
    ...
    dswipeApi.prototype.listDelegates = function (page, limit, orderBy) {
    ...
    dswipeApi.prototype.getDelegate = function (identifier) {
    ...
    dswipeApi.prototype.getDelegateBlocks = function (identifier, page, limit) {
    ...
    dswipeApi.prototype.getDelegateVoters = function (identifier, page, limit) {
    ...
    dswipeApi.prototype.searchDelegates = function (page, limit, body) {
    ...
    dswipeApi.prototype.getNodeConfig = function () {
    ...
    dswipeApi.prototype.getNodeCryptoConfig = function () {
    ...
    dswipeApi.prototype.getNodeFeeStats = function () {
    ...
    dswipeApi.prototype.getNodeStatus = function () {
    ...
    dswipeApi.prototype.getNodeSyncStatus = function () {
    ...
    dswipeApi.prototype.getPeers = function (page, limit, port, status, os, version, orderBy) {
    ...
    dswipeApi.prototype.getPeerByIP = function (ip) {
    ...
    dswipeApi.prototype.createTransaction = function (transactions) {
    ...
    dswipeApi.prototype.getTransactionByID = function (id) {
    ...
    dswipeApi.prototype.listTransactions = function (page, limit, type, blockId, id, orderBy) {
    ...
    dswipeApi.prototype.listUnconfirmedTransactions = function (page, limit) {
    ...
    dswipeApi.prototype.getUnconfirmedTransactionByID = function (id) {
    ...
    dswipeApi.prototype.searchTransactions = function (page, limit, body) {
    ...
    dswipeApi.prototype.getTransactionTypes = function () {
    ...
    dswipeApi.prototype.getTransactionFees = function () {
    ...
    dswipeApi.prototype.listVotes = function (page, limit, orderBy) {
    ...
    dswipeApi.prototype.getVoteByID = function (id) {
    ...
    dswipeApi.prototype.listWallets = function (page, limit, orderBy) {
    ...
    dswipeApi.prototype.getWalletByID = function (id) {
    ...
    dswipeApi.prototype.getWalletBalance = function (id) {
    ...
    dswipeApi.prototype.getWalletTransactions = function (id, page, limit) {
    ...
    dswipeApi.prototype.getWalletReceivedTransactions = function (id, page, limit) {
    ...
    dswipeApi.prototype.getWalletSentTransactions = function (id, page, limit) {
    ...
    dswipeApi.prototype.getWalletVotes = function (id, page, limit) {
    ...
    dswipeApi.prototype.getTopWallets = function (page, limit) {
    ...
    dswipeApi.prototype.searchWallets = function (page, limit, body) {
